                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="appearance-none block w-full px-4 py-3 pr-12 border-2 border-dark/30 rounded-md placeholder-dark/50 focus:outline-none focus:border-dark focus:ring-1 focus:ring-dark bg-white/80 transition-colors"
                                placeholder="••••••••"
                            />
                            <button
                                type="button"
                                onClick={() => setShowPassword(v => !v)}
                                className="absolute right-3 top-1/2 -translate-y-1/2 text-dark/40 hover:text-dark transition-colors p-1"
                                tabIndex={-1}
